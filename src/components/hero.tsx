    ...
    >
      ...
      >
        <motion.h1
          ...
          className="font-doto text-5xl md:text-7xl font-bold mb-6 tracking-tight"
        >
          {t.home.hero.title}
        </motion.h1>
        <motion.p
          variants={itemVariants}
          className="font-roboto text-xl md:text-2xl mb-8 text-neutral-200 max-w-2xl mx-auto"
        >
